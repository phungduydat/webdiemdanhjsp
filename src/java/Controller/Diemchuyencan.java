 ...
 * @author duyda
 */
@WebServlet(name = "Diemchuyencan", urlPatterns = {"/Diemchuyencan"})
public class Diemchuyencan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("Diemchuyencan.jsp").forward(request, response);
        }
    }
