                    ...
                    <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                ...
                                <a class="navbar-brand" href="javascript:;">Lop 21DTHD5<br>
                                    Môn : Công nghệ Phần Mềm</a>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="title">Điểm chuyên cần </h5>
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:forEach items="${l1}" var="l1">
                                                                <c:if test="${l1.getMSSV() == 2180605099}">
                                                                <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>3(nghỉ quá số ngày quy định)</td>
                                                        </tr>
                                                         <tr>
                                                            <td>Ngo Quoc Trong	</td>
                                                            <td>2180608444</td>
                                                            <td>21DTHD5</td>
                                                            <td>8</td>
                                                            <td>0</td>
